...
public class XboxOneControllerInput : MonoBehaviour
{
    ...
    [Tooltip("Minimum length of a thumbstick direction which is considered a non-null direction. Cannot be modified at runtime.")]
    [SerializeField]
    ...
    private Vector2 GetRightJoystickDirection()
    {
        ...
        return direction.SqrMagnitude() > squaredDirectionThreshold ? direction : RightJoysticDirection;
    }
